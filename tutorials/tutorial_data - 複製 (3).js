/**
 * War Inc Rising - 綜合攻略數據庫 (100% 繁中原文無損 + 三語翻譯 + 金額換算)
 */
const TUTORIAL_DATABASE = {
  ...
  "content": {
    ...
    "recruitment": {
      ...
      "pvp_list_zh": "競技場<br>公會戰爭", "pvp_list_cn": "竞技场<br>公会战争", "pvp_list_en": "Arena<br>Clan War",
      ...
      "h4_zh": "四、競技場隊伍組合", "h4_cn": "四、竞技场队伍组合", "h4_en": "IV. Arena Team Compositions",
      "arena_table_zh": [
    ...
    "forge": {
      ...
      "note_zh": "💡 提示：建議鍛造石平時盡量留存，並等待官方不定期推出的「鍛造石折扣限時活動」再投入。依稀有等級不同，活動期間通常可享有約 10%～40% 的折扣。由於資源極為珍貴，建議把握折扣時機再行使用。",
      "note_cn": "💡 提示：建议锻造石平时尽量留存，并等待官方不定期推出的「锻造石折扣限时活动」再投入。依稀有等级不同，活动期间通常可享有约 10%～40% 的折扣。由于资源极为珍贵，建议把握折扣时机再行使用。",
      "note_en": "💡 Tip: Save Forge Stones for 'Discount Events'. Depending on rarity, you can get a 10%-40% discount during events.",
    ...
    "spending": {
      ...
      "income_zh": [
        ...
        ["戰鬥通行證 (付費)", "週期", "3,800"],
        ["鑽石通行證 (付費)", "30天", "15,200"],
        ["<span style='background: rgba(0,78,146,0.05); font-weight:bold;'>合計預估</span>", "<td colspan='2' class='font-black text-blue-900 text-lg'>約 25,000 ~ 50,000 鑽</td>"]
      ],
      "income_cn": [
        ...
        ["战斗通行证 (付费)", "周期", "3,800"],
        ["钻石通行证 (付费)", "30天", "15,200"],
        ["<span style='background: rgba(0,78,146,0.05); font-weight:bold;'>合计预估</span>", "<td colspan='2' class='font-black text-blue-900 text-lg'>约 25,000 ~ 50,000 钻</td>"]
      ],
      "income_en": [
        ...
        ["<span style='background: rgba(0,78,146,0.05); font-weight:bold;'>Total Est.</span>", "<td colspan='2' class='font-black text-blue-900 text-lg'>~ 25,000 - 50,000 Diamonds</td>"]
      ],
      ...
      "note_zh": "<strong>✅ 總結建議：</strong> 專注培養心儀單位，建立後期強力隊伍。神話 6 級是分水嶺。",
      "note_cn": "<strong>✅ 总结建议：</strong> 专注培养心仪单位，建立后期强力队伍。神话 6 级是分水岭。",
      "note_en": "<strong>✅ Summary:</strong> Focus on desired units to build a strong late-game team. Mythic Lv.6 is the turning point."
    }
  }
};