/**
 * War Inc Rising - 綜合攻略數據庫 (100% 繁中原文無損 + 三語翻譯 + 絕對安全結構)
 */
const TUTORIAL_DATABASE = {
  ...
  "content": {
    ...
    "recruitment": {
      ...
      "pve_list_zh": "<li class='mode-list-item'>協作模式 / 狩獵 / 無限戰爭</li><li class='mode-list-item'>公會狩獵 / 沙盤演兵</li>",
      "pve_list_cn": "<li class='mode-list-item'>协作模式 / 狩猎 / 无限战争</li><li class='mode-list-item'>公会狩猎 / 沙盘演兵</li>",
      "pve_list_en": "<li class='mode-list-item'>Co-op / Hunting / Infinite War</li><li class='mode-list-item'>Clan Hunt / Battle Drills</li>",
      "pvp_list_zh": "<li class='mode-list-item'>競技場</li><li class='mode-list-item'>公會戰爭</li>",
      "pvp_list_cn": "<li class='mode-list-item'>竞技场</li><li class='mode-list-item'>公会战争</li>",
      "pvp_list_en": "<li class='mode-list-item'>Arena</li><li class='mode-list-item'>Clan War</li>",
      ...
      "arena_table_zh": [
        ["坦克", "<span class='tier-label'>初階：</span>南瓜守衛、岩石投擲者、神盾兵士<br><span class='tier-label'>中階：</span>騎士之王、焰火劍客、獅鷲騎士、櫻花浪人<br><span class='tier-label'>高階：</span>戰爭女神、蠻族暴君、光輝戰士"],
        ["單體傷害", "<span class='tier-label'>初階：</span>林地斥侯、見習法師、火焰法師<br><span class='tier-label'>中階：</span>精靈箭手、御風統領<br><span class='tier-label'>高階：</span>精靈箭手(高等)、九尾妖狐、叢林遊俠、霧影射手、亡骨槍手"],
        ["群體傷害", "<span class='tier-label'>初階：</span>林地斥侯、毒藥大師<br><span class='tier-label'>中階：</span>風語者、灰燼法師、熊靈勇士、地脈術士、風暴聖女、狂怒砲手<br><span class='tier-label'>高階：</span>熊靈勇士(高等)、叢林遊俠、亡骨槍手、血刃"],
        ["特殊功能", "<span class='tier-label'>破陣：</span>冰雪女王、炸彈兵<br><span class='tier-label'>增益：</span>神諭者、旋律編織者、星輝使徒、水靈巫師、潮汐領主、烈焰主宰<br><span class='tier-label'>減益：</span>鐵壁者、岩石投擲者、冰霜骷髏<br><span class='tier-label'>治癒：</span>木頭巫師、木靈守衛（兼副坦）<br><span class='tier-label'>控制：</span>暗月女皇、潮汐領主"]
      ],
      "arena_table_cn": [
        ["坦克", "<span class='tier-label'>初阶：</span>南瓜守卫、岩石投掷者、神盾士兵<br><span class='tier-label'>中阶：</span>骑士之王、焰火剑客、狮鹫骑士、樱花浪人<br><span class='tier-label'>高阶：</span>战争女神、蛮族暴君、光辉战士"],
        ["单体伤害", "<span class='tier-label'>初阶：</span>林地斥候、见习法师、火焰法师<br><span class='tier-label'>中阶：</span>精灵箭手、御风统领<br><span class='tier-label'>高阶：</span>精灵箭手(高等)、九尾妖狐、丛林游侠、雾影射手、亡骨枪手"],
        ["群体伤害", "<span class='tier-label'>初阶：</span>林地斥候、毒药大师<br><span class='tier-label'>中阶：</span>风语者、灰烬法师、熊灵勇士、地脉术士、风暴圣女、狂怒炮手<br><span class='tier-label'>高阶：</span>熊灵勇士(高等)、丛林游侠、亡骨枪手、血刃"],
        ["特殊功能", "<span class='tier-label'>破阵：</span>冰雪女王、炸弹兵<br><span class='tier-label'>增益：</span>神谕者、旋律编织者、星辉使徒、水灵巫师、潮汐领主、烈焰主宰<br><span class='tier-label'>减益：</span>铁壁者、岩石投掷者、冰霜骷髅<br><span class='tier-label'>治愈：</span>木头巫师、木灵守卫（兼副坦）<br><span class='tier-label'>控制：</span>暗月女皇、潮汐领主"]
      ],
      "arena_table_en": [
        ["Tank", "<span class='tier-label'>Basic:</span> Pumpkin Guard, Rock Thrower, Paladin<br><span class='tier-label'>Mid:</span> The Knight King, Flame Duelist, Gryphon Knight, Sakura Ronin<br><span class='tier-label'>High:</span> Goddess of War, Barbarian Tyrant, Radiant Warrior"],
        ["Single DPS", "<span class='tier-label'>Basic:</span> Forest Scout, Apprentice Mage, Flame Mage<br><span class='tier-label'>Mid:</span> Elven Archer, Windlord<br><span class='tier-label'>High:</span> Elven Archer (High), Nine-Tailed Fox, Jungle Ranger, Mist Archer, Bone Marksman"],
        ["AOE DPS", "<span class='tier-label'>Basic:</span> Forest Scout, Poison Master<br><span class='tier-label'>Mid:</span> Wind Apostle, Ashen Arcenist, Ursa Champion, Geomancer, Storm Maiden, Fury Cannoneer<br><span class='tier-label'>High:</span> Ursa Champion (High), Jungle Ranger, Bone Marksman, Red Blade"],
        ["Special", "<span class='tier-label'>Breaker:</span> Frost Queen, Bomber<br><span class='tier-label'>Buff:</span> Oracle, Melody Weaver, Starlight Apostle, Ripple Wizard, Tide Lord, Blazeking<br><span class='tier-label'>Debuff:</span> Iron Bulwark, Rock Thrower, Frost Skeleton<br><span class='tier-label'>Heal:</span> Wooden Wizard, Woodland Guardian<br><span class='tier-label'>CC:</span> Darkmoon Queen, Tide Lord"]
      ]
    },
    "forge": {
    ...
    "spending": {
      ...
      "income_zh": [
        ["每日任務 (賽季/日/週)", "週期", "6,400"], ["指揮所產出 (Lv.5)", "週期", "7,200"], ["免費通行證", "週期", "1,020"],
        ["活動/公會獎勵組合", "週期", "10,000 ~ 15,000"], ["戰鬥通行證 (付費)", "週期", "3,800"], ["鑽石通行證 (付費)", "30天", "15,200"]
      ],
      "income_cn": [
        ["每日任务 (赛季/日/周)", "周期", "6,400"], ["指挥所产出 (Lv.5)", "周期", "7,200"], ["免费通行证", "周期", "1,020"],
        ["活动/公会奖励组合", "周期", "10,000 ~ 15,000"], ["战斗通行证 (付费)", "周期", "3,800"], ["钻石通行证 (付费)", "30天", "15,200"]
      ],
      "income_en": [
        ["Daily/Season Quests", "Cycle", "6,400"], ["Command Center (Lv.5)", "Cycle", "7,200"], ["Free Pass", "Cycle", "1,020"],
        ["Events/Guild Rewards", "Cycle", "10,000 ~ 15,000"], ["Battle Pass (Paid)", "Cycle", "3,800"], ["Diamond Pass (Paid)", "30 Days", "15,200"]
      ],
      "income_total_zh": "約 25,000 ~ 50,000 鑽", "income_total_cn": "约 25,000 ~ 50,000 钻", "income_total_en": "~ 25,000 - 50,000 Diamonds",
      ...
      "tiers_h_zh": "🏷️ 課金等級建議 (台幣)", "tiers_h_cn": "🏷️ 氪金等级建议 (人民币)", "tiers_h_en": "🏷️ Spending Tiers (USD)",
      "tier_th_zh": ["等級", "說明", "預估金額"], "tier_th_cn": ["等级", "说明", "预估金额"], "tier_th_en": ["Tier", "Description", "Est. USD"],
      "tiers_zh": [
        ["無課", "完全無花費", "0"], ["微課", "只課戰鬥通行證", "330"], ["小課", "戰鬥通行證 + 雙鑽石通行證", "1,000"],
        ["中小課", "前述 + 成長加速禮包 1-2 次", "1,600 ~ 2,600"], ["中課", "前述 + 基礎補給禮包/進階補給禮包", "4,000 ~ 9,000"], ["大課", "前述 + 不定額永恆石禮包、成長加速、各式禮包", "無上限"]
      ],
      "tiers_cn": [
        ["无氪", "完全无花费", "0"], ["微氪", "只氪战斗通行证", "71"], ["小氪", "战斗通行证 + 双钻石通行证", "215"],
        ["中小氪", "前述 + 成长加速礼包 1-2 次", "344 ~ 559"], ["中氪", "前述 + 基础补给礼包/进阶补给礼包", "860 ~ 1,936"], ["大氪", "前述 + 不定额永恒石礼包、成长加速、各式礼包", "无上限"]
      ],
      "tiers_en": [
        ["F2P", "No spending", "$0"], ["Low", "Battle Pass only", "~$10"], ["Casual", "Battle Pass + Diamond Pass", "~$30"],
        ["Dolphin", "Above + Growth Acceleration x1-2", "~$50 ~ $80"], ["High", "Above + Basic/Advanced Supplies", "~$125 ~ $280"], ["Whale", "Above + Eternity Stones & Various Offers", "Limitless"]
      ],
